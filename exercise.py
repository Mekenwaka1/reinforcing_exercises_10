        ...
        if char in opening_chars:  # opening bracket
            ...
            if open:
                ...
                if char == required_char:  # it's the right kind of closing bracket
                    ...
                    print(
                        "* You have a syntax error: there is an unexpected {} where there should be a {}".format(char, required_char))
                    return False

            else:  # there's nothing to close
                print(
                    "* You have a syntax error: there is an unexpected {} where there is nothing to close.".format(char))
...
print(check_syntax("<html> [this][ is some text</html>"))
print("*****")
print(check_syntax("<html> <html> [this] is some text</html"))
